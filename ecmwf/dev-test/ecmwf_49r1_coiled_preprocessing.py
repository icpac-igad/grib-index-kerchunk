...
def main():
    ...
    @coiled.function(
        vm_type=args.vm_type,          # 50r1 driver: n2-standard-2
        software=args.software,        # 50r1 driver: gik-coiled-v6
        workspace=args.workspace,      # 50r1 driver: gcp-sewaa-nka
        name="func-ecmwf-49r1",        # distinct from 50r1's func-ecmwf-50r1
        region=args.region,            # 50r1 driver: us-east1
        arm=False,                     # 50r1 driver: arm=False
        idle_timeout="30 minutes",     # 50r1 driver: 30 minutes
    )
    def scan_one(task):
