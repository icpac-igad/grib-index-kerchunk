...
def ecmwf_enfo_index_unique_dict(edf):
...
def ecmwf_enfo_index_df_create_with_keys(ecmwf_s3url):
    fs = fsspec.filesystem("s3")
    suffix = 'index'
...
def ecmwf_enfo_filter_scan_grib_step_a(ecmwf_s3url):
    """
    ...
    idx_mapping, _ = ecmwf_enfo_index_df_create_with_keys(ecmwf_s3url)
